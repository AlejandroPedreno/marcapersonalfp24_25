                    ...
                    <form action="{{ action([App\Http\Controllers\CurriculoController::class, 'getEdit'], ['id' => $id]) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="user_id" id="user_id"
                                value="{{ $arrayCurriculos['user_id'] }}>
                 </div>

                 <div class="form-group">
                            <label for="video_currículum">URL Videocurrículo</label>
                            <input type="url" name="video_currículum" id="video_currículum" class="form-control"
                                value="{{ $arrayCurriculos['video_curriculum'] }}>
                 </div>
                    ...
                    <div class="form-group">
                            ...
                            <textarea name="texto_currículum" id="texto_currículum" class="form-control" rows="5"
                                value="{{ $arrayCurriculos['texto_curriculum'] }}></textarea>
